...
import { View, Text, TouchableOpacity, StyleSheet, ImageBackground, ScrollView, Image, SafeAreaView, Alert } from 'react-native';
    ...
    <SafeAreaView style={{ flex: 1 }}>
      ...
      <View style={styles.itemsContainer}>
        <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={{ paddingHorizontal: 32 }}>
          {items.map(item => (
            <TouchableOpacity key={String(item.id)} activeOpacity={0.5}
              style={[
                styles.item,
